...
Base64Encoder::Base64Encoder(std::string & filePath):
	filePath(filePath)
{}

Base64Encoder::Base64Encoder(){}

std::vector<unsigned char> & Base64Encoder::getByteStream(){
	buffer.clear();
...
void Base64Encoder::setFilePath(std::string & newFilePath){
	filePath = newFilePath;
}


std::string Base64Encoder::encode(){
